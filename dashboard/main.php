<div class="container-main">
    ...
    <div class="dashboard">
        ...
        <?php
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_view_medicos == 1){
                echo '<div class="card">
                            <h2>Médicos</h2>
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_view_pacientes == 1){
                echo '<div class="card">
                            <h2>Pacientes</h2>
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_view_payments == 1){
                echo '<div class="card">
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_view_agendamentos == 1){
                echo '<div class="card">
                    <h2>Agendamentos</h2>
    ...
    <div class="kanban">
        <?php
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_new_agendamentos == 1) {
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_new_pacientes == 1) {
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_new_medicos == 1) {
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_new_acompanhamentos == 1) {
            ...
            if($user->tipo == 'FUNCIONARIO' && $user->perms->dashboard_new_pagamentos == 1) {
