    ...
    public function updateStatus($agenda): bool
    {
      ...
      try {
        ...
        catch(PDOException $ex)
        {
          ...
          file_put_contents('AGENDA_'.uniqid().'.json', json_encode($ex, JSON_PRETTY_PRINT));
          file_put_contents('./logs/AGENDA_'.uniqid().'.json', json_encode($ex, JSON_PRETTY_PRINT));
          return false;
      }
    }
    ...
    public function Add($ag): bool
    {
      ...
      $stmt->bindValue(':payment_method', $ag->payment_method);
        ...
        }catch(PDOException $ex)
        {
          ...
          file_put_contents('aaaaaaaaaaaag-error.txt', print_r($ex, true));
          return false;
        }
    }
