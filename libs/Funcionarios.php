...
class Funcionarios {
  ...
  public function Add($funcionario):bool {
    ...
    try{
       ...
       file_put_contents('func.txt', print_r($funcionario, true));
    }catch(PDOException $error){
      file_put_contents('error.func.txt', print_r($error, true));
  ...
  public function Update($funcionario):bool {
    ...
    file_put_contents('exceptions.txt',print_r($stmt, true));
