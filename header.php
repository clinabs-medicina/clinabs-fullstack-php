    ...
    <div class="flex-container">
        ...
        <nav class="menu-header">
            <ul class="m-0">
                ...
                <?= $user->perms->link_agendar_consulta ? '<li class="consult-li-link data-ref="consulta"><a href="/agendamento" alt="Agendar Consulta" title="">AGENDAR CONSULTA</a></li>' : '' ?>
                <?= $user->perms->link_medicos ? '<li data-ref="medicos"><a href="/medicos" alt="Nossos Médicos" title="">MÉDICOS</a></li>' : '' ?>
                <?= $user->perms->link_produtos == 1 ? '<li data-ref="produtos"><a href="/produtos" alt="Nossos produtos" title="">PRODUTOS</a></li>' : '' ?>
                <?= $user->perms->link_unidades ? '<li data-ref="Unidades"><a href="/unidades" alt="" title="">UNIDADES</a></li>' : '' ?>
                <?= $user->perms->link_cadastro ? '<li data-ref="cadastro"><a href="/cadastro" alt="" title="">CADASTRE-SE</a></li>' : '' ?>
                <?= $user->perms->link_academy ? '<li data-ref="/academy"><a href="/academy" alt="" title="">ACADEMY</a></li>' : '' ?>
                <?= $user->perms->link_blog_medico ? '<li data-ref="blog"><a href="/blog/medico" alt="" title="">BLOG</a></li>' : '' ?>
                <?php } else { ?>
        ...
        <nav class="menu-ico">
            <div class="m-0">
                ...
                <?= $user->perms->link_notificacao ? '<li data-badge="0"><a href="#"><img class="ico-hover" src="/assets/images/ico-notifica.svg" alt=""></a></li>' : '' ?>
                        ...
                        <div class="menu-user-flex">
                            ...
                            <div class="menu-user-links">
                                <ul class="m-0">
                                    ...
                                    <?= $user->perms->link_funcionarios == 1 ? '<li><img src="/assets/images/ico-menu-funcionario.svg" alt=""><a href="/cadastros/funcionarios">FUNCIONÁRIOS</a></li>' : '' ?>
                                    <?= $user->perms->link_paciente == 1 ? '<li><img src="/assets/images/ico-menu-phone.svg" alt=""><a href="/cadastros/pacientes">PACIENTES</a></li>' : '' ?>
                                    <?= $user->perms->link_menu_medicos == 1 ? '<li><img src="/assets/images/ico-menu-medico.svg" alt=""><a href="/cadastros/medicos">MÉDICOS</a></li>' : '' ?>
                                    <?= $user->perms->link_usuarios == 1 ? '<li><img src="/assets/images/ico-menu-phone.svg" alt=""><a href="/cadastros/usuarios">Fornecedores/Prestadores</a></li>' : '' ?>
                                    <?= $user->perms->link_agenda == 1 && $user->tipo == 'MEDICO' || $user->tipo == 'FUNCIONARIO' ? '<li><img src="/assets/images/ico-menu-clock.svg" alt=""><a href="/agenda">AGENDA</a></li>' : '<li><img src="/assets/images/ico-menu-clock.svg" alt=""><a href="/agenda">MEUS AGENDAMENTOS</a></li>' ?>
                                    <!--<?= $user->perms->link_financeiro == 1 ? '<li><img src="/assets/images/ico-menu-money.svg" alt=""><a href="/financeiro">FINANCEIRO</a></li>' : '' ?>-->
                                    <?= $user->perms->link_financeiro == 1 ? '<li><img src="/assets/images/ico-menu-money.svg" alt=""><a href="/faturamento">FATURAMENTO</a></li>' : '' ?>
