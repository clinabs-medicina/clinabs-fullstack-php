<section class="main">
    ...
    <div class="flex-container produtos-flex">
        ...
        <table class="display table" id="faturamento-tb">
            ...
            <tbody>
                <?php
                    $payloads = $pdo->query("SELECT reference,(SELECT nome_completo FROM PACIENTES WHERE payment_id = customer LIMIT 1) AS customer,asaas_payload FROM VENDAS WHERE payment_id LIKE 'pay_%' AND customer LIKE 'cus_%' AND asaas_payload LIKE '%pay_%';");
