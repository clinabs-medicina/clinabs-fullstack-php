                ...
                <section class="form-grid area1">
                    <section class="form-group">
                        ...
                        <input type="text" id="nome_preferencia" class="form-control capitalize" name="nome_preferencia"
                            placeholder="Digite seu nome de Preferência."
                    ...
                    <section class="form-group">
                        ...
                        <input type="text" data-mask="00/00/0000" name="data_nascimento"
                            class="form-control validate-age" id="data_nascimento" required="" placeholder="__/__/____"
                            maxlength="10" value="<?=($user->tipo == 'PACIENTE' ? $user->data_nascimento :'')?>" />
                    </section>
                </section>
