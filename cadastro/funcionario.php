...
<section class="main">
    <div class="flex-container">
        <form id="cadastroFuncionarioBasico" action="/form/cadastro.funcionario.php" method="POST" class="wizard-form" autocomplete="on">
            <h3 class="form-title titulo-h1">Cadastro de Funcionário</h3>
            <!-- Indicadores -->
            ...
            <section class="form-grid area1">
                ...
                <section class="form-grid area1">
                    ...
                    <section class="form-group">
                        ...
                        <input type="text" disabled="disabled" id="celular" name="celular" class="form-control" required placeholder="(__) _ ____-____" value="<?=($user->tipo == 'PACIENTE' ? $user->celular :'')?>" />
                    </section>
            ...
            <div class="form-footer">
                ...
                <button type="submit" style="display: block !important" class="btn-step-submit btn-button1">FINALIZAR</button>
            </div>
        </form>
    </div>
</section>