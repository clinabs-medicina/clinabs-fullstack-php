$(function(){$('.btns-street label[data-action="editar"]').on("click",function(){let e=$(this).closest(".street-item");Swal.fire({title:"Editar Endere\xe7o",width:"75%",allowOutsideClick:!1,html:`<div class="street-editor" style="display: block;">
   ...
   </div>`,showConfirmButton:!0,showCancelButton:!1,showDenyButton:!0,confirmButtonText:"SALVAR",denyButtonText:"cancelar",didOpen:function(){let o=JSON.parse($(e).find(".input-data").val().replaceAll("'",'"'));$(".swal2-html-container").find("#endereco_nome").val(o.nome),$(".swal2-html-container").find("#tipo_endereco").val(o.tipo_endereco).trigger("change"),$(".swal2-html-container").find("#cep").val(o.cep),$(".swal2-html-container").find("#endereco").val(o.logradouro),$(".swal2-html-container").find("#numero").val(o.numero),$(".swal2-html-container").find("#complemento").val(o.complemento),$(".swal2-html-container").find("#cidade").val(o.cidade),$(".swal2-html-container").find("#bairro").val(o.bairro),$(".swal2-html-container").find("#uf").val(o.uf).trigger("change"),$(".swal2-html-container").find("#cep").mask("00.000-000",{placeholder:"__.____-___",clearIfNotMatch:!0,onComplete:function(e){8==e.replace(/\D/g,"").length&&fetch(`https://viacep.com.br/ws/${e.replace(/\D/g,"")}/json/`).then(e=>e.json()).then(e=>{$(".swal2-html-container").find("#endereco").val(e.logradouro),$(".swal2-html-container").find("#cidade").val(e.localidade),$(".swal2-html-container").find("#uf").val(e.uf).trigger("change"),$(".swal2-html-container").find("#bairro").val(e.bairro),$(".swal2-html-container").find("#numero").focus()})}})}}).then(function(o){if(o.isConfirmed){let t=JSON.parse($(e).find(".input-data").val().replaceAll("'",'"')),n={nome:$(".swal2-html-container").find("#endereco_nome").val(),cep:$(".swal2-html-container").find("#cep").val(),logradouro:$(".swal2-html-container").find("#endereco").val(),numero:$(".swal2-html-container").find("#numero").val(),complemento:$(".swal2-html-container").find("#complemento").val(),cidade:$(".swal2-html-container").find("#cidade").val(),bairro:$(".swal2-html-container").find("#bairro").val(),uf:$(".swal2-html-container").find("#uf").val(),tipo_endereco:$(".swal2-html-container").find("#tipo_endereco").val(),id:t.id,user_token:t.user_token,isDefault:t.isDefault,token:t.token};console.log(n),$(e).find(".input-data").val(JSON.stringify(n).replaceAll('"',"'"))}})}),$('.btns-street label[data-action="excluir"]').on("click",function(){let e=$(this).closest(".street-item");Swal.fire({title:"Aten\xe7\xe3o",text:"Deseja Excluir Este Endere\xe7o?",showConfirmButton:!0,showCancelButton:!1,showDenyButton:!0,confirmButtonText:"SIM",denyButtonText:"N\xc3O",icon:"question",allowOutsideClick:!1}).then(function(o){if(o.isConfirmed){let t=JSON.parse($(e).find(".input-data").val().replaceAll("'",'"'));t.delete=!0,$(e).find(".input-data").val(JSON.stringify(t).replaceAll('"',"'")),$(e).fadeOut()}})}),$('.btns-street label[data-action="def"]').on("click",function(){let e=$(this).closest(".street-item");$(".street-item").each(function(){let e=JSON.parse($(this).find(".input-data").val().replaceAll("'",'"'));e.isDefault=!0,$(this).find(".default-street").text(" "),$(this).find(".input-data").val(JSON.stringify(e).replaceAll('"',"'"))});let o=JSON.parse($(e).find(".input-data").val().replaceAll("'",'"'));o.isDefault=!0,$(e).find(".input-data").val(JSON.stringify(o).replaceAll('"',"'")),$(e).find(".default-street").text("(Padr\xe3o)")})});