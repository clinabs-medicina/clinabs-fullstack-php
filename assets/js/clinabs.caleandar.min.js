function createCalendar(e, t, a) {
    ...
    function l() {
        ...
        if (a.className += "cld-datetime", e.Options.NavShow && ! e.Options.NavVertical) {
            ...
            n.innerHTML = '<svg height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,50 75,0 75,100"></polyline></svg>',
            a.appendChild(n)
        }
        ...
        if (l.className += " today", l.innerHTML = s[e.Selected.Month] + ", " + e.Selected.Year, a.appendChild(l), e.Options.NavShow && ! e.Options.NavVertical) {
            ...
            i.innerHTML = '<svg height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,0 75,50 0,100"></polyline></svg>',
            a.appendChild(i)
        }
    ...
    function d() {
        ...
        for (var n = 0; n < e.Selected.Days; n++) {
            ...
            for (var i =( n + e.Selected.FirstDay) % 7, d = 0; d < e.Options.DisabledDays.length; d++) 
                i == e.Options.DisabledDays[d] && (l.className += " disableDay");
            ...
            for (var o = t(n + 1), c = 0; c < e.Model.length; c++) {
                ...
                if (s.getTime() == p.getTime()) {
                    ...
                    if (h.className += "cld-title", "function" == typeof e.Model[c].Link || e.Options.EventClick) {
                        ...
                        h.innerHTML += '<a href="' + e.Model[c].Link + '">' + e.Model[c].Title + "</a>";
                     o.appendChild(h)
                }
            }
            l.appendChild(o),
        ...
        for (var n = 0; n < y - e.Selected.LastDay; n++) {
            ...
            for (var i =( n + e.Selected.LastDay + 1) % 7, d = 0; d < e.Options.DisabledDays.length; d++) 
                i == e.Options.DisabledDays[d] && (l.className += " disableDay");
    ...
    if ("undefined" != typeof a) {
        ...
        for (var c in e.Options) 
            "function" != typeof e.Options[c] && "object" != typeof e.Options[c] && e.Options[c] ? t.className += " " + c + "-" + e.Options[c] : 0;
