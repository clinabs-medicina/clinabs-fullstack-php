  ...
  */
    !function (t, e) {
            ...
            const B = {
                ...
                getDataAttribute: (t, e) => $(t.getAttribute(`data-bs-${
                    W(e)
                }`))
            };
            class F {
                ...
                _typeCheckConfig(t, e = this.constructor.DefaultType) {
                    for (const n of Object.keys(e)) {
                        ...
                        if (!new RegExp(s).test(a)) 
                            ...
                            }: Option "${n}" provided type "${a}" but expected type "${s}".`)
            ...
            const q = (t, e = "hide") => {
                ...
                const Q = {
                        ...
                        children: (t, e) => [].concat(... t.children).filter(
                            (t => t.matches(e))
                        ),
                        parents(t, e) {
                            const i = [];
                ...
                function fe(t) {
                    ...
                    return f = x.x,
                    g = x.y,
                    l ? Object.assign({}, O, ((C = {})[y] = b ? "0" : "", C[v] = _ ? "0" : "", C.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + g + "px)" : "translate3d(" + f + "px, " + g + "px, 0)",
        ...
        class bn extends z {
            ...
            _observerCallback(t) {
                const e = t => this._targetLinks.get(`#${
                        t.target.id
                    }`),
                    i = t => {
            ...
            class kn extends z {
                ...
                _setInitialAttributesOnTargetPanel(t) {
                    const e = n(t);
                    e && (this._setAttributeIfNotExists(e, "role", "tabpanel"), t.id && this._setAttributeIfNotExists(e, "aria-labelledby", `#${
                        t.id
                    }`))
                }
                _toggleDropDown(t, e) {
